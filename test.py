...
print(f'  {py_avg/rust_avg*100-100 if py_avg > rust_avg else -rust_avg/py_avg*100+100}% (avg)')
print(f'  {py_max/rust_max*100-100 if py_max > rust_max else -rust_max/py_max*100+100}% (max)')
print(f'  {py_min/rust_min*100-100 if py_min > rust_min else -rust_min/py_min*100+100}% (min)')
